...
//	public MemberVO(String mem_regno1, String mem_regno2){
...
//	}
	...
	// multipart 요청시 input type=file name=files 최대 2개의 파일 맵핑
	// 실제 업로드된 파일 셋팅
	private List<File> files;
	// 실제 업로드된 파일 컨텐츠타입 셋팅
	//   input name속성값+ContentType;
	private List<String> filesContentType;
	// 실제 업로드된 파일 명
	//   input name속성값+FileName;
